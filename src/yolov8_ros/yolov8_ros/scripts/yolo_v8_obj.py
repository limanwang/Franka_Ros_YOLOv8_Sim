...
class Yolo_Dect:
    def __init__(self):
        ...
        pub_topic = rospy.get_param('~pub_topic', '/yolov8/ObjBoundingBoxes')
        ...
        self.image_pub = rospy.Publisher(
            '/yolov8/detection_image2',  Image, queue_size=1)
