...
if("TRUE" STREQUAL "TRUE")
  set(rpl_panda_with_rs_SOURCE_PREFIX /home/eunice/panda2_ws/src/arm/rpl_panda_with_rs)
  set(rpl_panda_with_rs_DEVEL_PREFIX /home/eunice/panda2_ws/devel)
  ...
  set(rpl_panda_with_rs_INSTALL_PREFIX /home/eunice/panda2_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rpl_panda_with_rs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eunice/panda2_ws/src/arm/rpl_panda_with_rs/${idir}'.  ${_report}")
    endif()
